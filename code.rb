puts "Let's take a look at the following compound data structure:"
...
brian = people["Brian Heller"]["children"]
puts brian.count
...
puts "Let's try another compound data structure:"
...
puts "Write Ruby code to find out the answers to the following questions:"
...
sets_of_people[0].each do |hash|
  hash.each { |name, info|} puts name if info["company"].include?("m") || info["company"].include?("M") }
end
